      ...
      <output className="my-3 bg-secondary">
        <ol className="my-3 mx-2 text-light">
          <li className="d-flex justify-content-between mb-2">
            {details.employeeID}
            <Button variant="transparent" className="btn btn-sm">
              <Clipboard />
            </Button>
          </li>
          <li className="d-flex justify-content-between">
            {details.firstName}{" "}
            <Button variant="transparent" className="btn btn-sm mb-2">
              <Clipboard />
            </Button>
          </li>
          <li className="d-flex justify-content-between">
            {details.lastName}{" "}
            <Button variant="transparent" className="btn btn-sm text-light">
              <Clipboard />
            </Button>
          </li>
        </ol>
