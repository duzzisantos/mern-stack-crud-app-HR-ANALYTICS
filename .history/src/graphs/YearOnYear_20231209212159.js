...
const YearOnYear = ({ chartData, employeeId, graphYear }) => {
  const {
    qualityOfWork,
    quantityOfWork,
    responsibility,
    punctuality,
    delivery,
  } = getUniqueAppraisals(chartData, employeeId, graphYear);

  console.log(getUniqueAppraisals(chartData, employeeId, graphYear));
