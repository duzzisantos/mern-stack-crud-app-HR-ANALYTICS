...
const Appraisal = () => {
  ...
  return (
    <>
      <Auth />
      <Container fluid className="d-flex justify-content-center shadow-sm">
        <form
          className="col-lg-6 py-3 d-flex flex-column border border-secondary-subtle gap-3 justify-content-center align-items-center"
