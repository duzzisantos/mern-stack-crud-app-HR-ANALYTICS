  ...
  return (
    <>
      ...
      <Container fluid className="d-flex justify-content-center py-4">
        <form
          className="col-lg-6 py-3 rounded-2 shadow-sm d-flex flex-column border gap-3 justify-content-center align-items-center"
          encType="multipart/formdata"
          onSubmit={handleSubmit}
        >
          <h1 className="fs-3 fw-bold">Appraise Employee</h1>
          <div className="col-9">
